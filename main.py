...
elif int_userSpeed > max_speed  and int_userSpeed <= 61:
...
elif int_userSpeed > max_speed + 30 and int_userSpeed <= max_speed + 35:
...
elif int_userSpeed > max_speed + 35 and int_userSpeed <= max_speed + 40:
...
elif int_userSpeed > max_speed + 40 and int_userSpeed <= max_speed + 49:
...
elif int_userSpeed > max_speed + 49 and int_userSpeed <= max_speed + 59:
